...
public partial class StopCoinJoinViewModel : RoutableMethodViewModel
{
    ...
    public override IRoutable? ToJobResult(object? result)
    {
        ...
        {
            return new Success { Message = $"Stopped coinjoin for wallet {WalletName}" }.ToViewModel(RpcService, NavigationService, DetailsNavigationService);
        }
