...
public partial class GetFeeRatesViewModel : RoutableMethodViewModel
{
    ...
    {
        var result = await RpcService.Send<RpcGetFeeRatesResult>(job.RpcMethod, job.RpcServerUri);
    ...
    public override IRoutable? ToJobResult(object? result)
    {
        ...
        {
            return new GetFeeRatesInfo { FeeRates = rpcGetFeeRatesResult.Result }.ToViewModel(RpcService, NavigationService, DetailsNavigationService, GetFeeRatesCommand);
        }
